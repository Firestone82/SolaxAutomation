...
|---|---|---|
| Battery charge guard | `automation.battery` | Checks the battery against charge targets through the day; if it is behind schedule, stops feeding the grid and switches to self use. |
